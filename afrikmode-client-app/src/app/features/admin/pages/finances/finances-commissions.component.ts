// Finances Commissions Component
...
@Component({
  selector: 'app-finances-commissions',
  standalone: true,
  ...
  template: `
    <div class="admin-page">
      <div class="page-header">
        ...
        <p class="page-subtitle">Commissions prélevées sur les transactions</p>
      </div>
      ...
      <mat-card class="content-card">
        <p class="info-text">
          ...
          La plateforme a collecté 8,567 € en commissions
        </p>
      </mat-card>
    </div>
  `,
...
export class FinancesCommissionsComponent {}
