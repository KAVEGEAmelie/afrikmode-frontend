...
@Component({
  selector: 'app-finances-revenues',
  standalone: true,
  ...
  template: `
    <div class="admin-page">
      <div class="page-header">
        ...
        <p class="page-subtitle">Revenus générés par la plateforme</p>
      </div>
      ...
      <mat-card class="content-card">
        <p class="info-text">
          ...
          La plateforme a généré 125,430 € de revenus au total
        </p>
      </mat-card>
    </div>
  `,
...
export class FinancesRevenuesComponent {}
