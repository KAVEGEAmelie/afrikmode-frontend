// src/app/features/admin/pages/orders/orders-delivered.component.ts
...
@Component({
  ...
  template: `
    <div class="admin-page">
      <div class="page-header">
        ...
        <p class="page-subtitle">Commandes livrées avec succès</p>
      </div>
      ...
      <mat-card class="content-card">
        <p class="info-text">
          ...
          232 commandes livrées avec succès ce mois
        </p>
      </mat-card>
    </div>
  `,
  styles: [`
    ...
    .stat-icon { font-size: 48px; width: 48px; height: 48px; color: #64748b; }
